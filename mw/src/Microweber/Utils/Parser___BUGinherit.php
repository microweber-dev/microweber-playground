...
//                        d($field_content);
                    ...
                    if ($field_content != false and $field_content != '' and is_array($field_content) and isset($field_content['value'])) {
                ...
                foreach ($reps as $elk => $value) {
                    ...
                    if (!isset($mw_replaced_edit_fields_vals[$global_holder_hash])) {
                        ...
                        if ($value != '') {
                            ...
                            $val_rep = $this->_replace_editable_fields($val_rep);
